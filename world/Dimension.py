...
class Dimension:
    ...
    def get_chunk_for_position(self, position: typing.Union[typing.Tuple[float, float, float], block.Block.Block],
    ...
    def get_block(self, position: typing.Tuple[int, int, int]) -> typing.Union[block.Block.Block, str, None]:
