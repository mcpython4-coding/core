...
import globals as G
import mcpython.crafting.IRecipeInterface
...
class GridRecipeInterface(mcpython.crafting.IRecipeInterface.IRecipeInterface):
    ...
    def __init__(self, slot_input_map, slot_output_map, maxsize=None, minsize=None, enabled=True,
        ...
        self.slot_output_map: mcpython.gui.Slot.Slot = slot_output_map
        ...
        self.active_recipe: mcpython.crafting.IRecipeType.IRecipe = None
    ...
    def check_recipe_state(self):
        ...
        for recipe in recipes:
            state = False
            if issubclass(type(recipe), mcpython.crafting.GridRecipes.GridShaped) and self.shaped_enabled:
                state = self._check_shaped(recipe, itemtable)
            elif issubclass(type(recipe), mcpython.crafting.GridRecipes.GridShapeless) and self.shapeless_enabled:
    ...
    @staticmethod
    def _check_shaped(recipe: mcpython.crafting.GridRecipes.GridShaped, itemtable: dict) -> bool:
    ...
    @staticmethod
    def _check_shapeless(recipe: mcpython.crafting.GridRecipes.GridShapeless, items: list) -> bool:
        items = items[:]
    ...
    def on_output_shift_click(self, slot, x, y, button, modifiers, player):
        ...
        while self.active_recipe == old_recipe:
            ...
            self.slot_output_map.set_itemstack(mcpython.gui.ItemStack.ItemStack.get_empty())
