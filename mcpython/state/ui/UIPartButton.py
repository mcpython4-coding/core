...
class UIPartButton(UIPart.UIPart):
    def __init__(self, size, text, position, press=mcpython.event.EventInfo.MousePressEventInfo(pyglet.window.mouse.LEFT),
        ...
        self.text = text
        self.press: mcpython.event.EventInfo.MousePressEventInfo = press
...
class UIPartToggleButton(UIPartButton):
    def __init__(self, size, textpossibilitys, position,
        ...
        self.index = start
        self.text = ""
        self.toggle: mcpython.event.EventInfo.MousePressEventInfo = toggle
        self.retoggle: mcpython.event.EventInfo.MousePressEventInfo = retoggle
