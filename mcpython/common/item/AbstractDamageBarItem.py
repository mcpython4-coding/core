...
class AbstractDamageBarItem(mcpython.common.item.AbstractItem.AbstractItem, ABC):
    ...
    def get_damage_info(self) -> typing.Optional[typing.Tuple[float, typing.Tuple[int, int, int]]]:
...
class DefaultDamageBarItem(AbstractDamageBarItem, ABC):
    def get_damage_info(self) -> typing.Optional[typing.Tuple[float, typing.Tuple[int, int, int]]]:
        ...
        if damage == 1 or self.unbreakable: return

        if damage > .5: return damage, (0, 255, 0)
        if damage > .25: return damage, (0, 128, 0)
