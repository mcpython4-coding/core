...
@G.registry
class DataFixer1to2(mcpython.server.storage.datafixers.IDataFixer.IStorageVersionFixer):
...
@G.registry
class ChunkDataFixer1to2(mcpython.server.storage.serializer.Chunk.ChunkDataFixer):
