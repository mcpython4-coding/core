...
def load_blocks():
    full_template = mcpython.common.factory.BlockFactory.BlockFactory().setGlobalModName("minecraft").setTemplate()
...
mcpython.common.mod.ModMcpython.mcpython.eventbus.subscribe("stage:block:factory_usage", load_blocks,
