...
import mcpython.gui.InventoryPlayerMain
...
class Player(mcpython.entity.Entity.Entity):
    ...
    def create_inventories(self):
        import mcpython.gui.InventoryCraftingTable as InvCrafting
        import mcpython.gui.InventoryPlayerHotbar as InvHotbar

        hotbar = self.inventories['hotbar'] = InvHotbar.InventoryPlayerHotbar()
        self.inventories['main'] = mcpython.gui.InventoryPlayerMain.InventoryPlayerMain(hotbar)
        self.inventories['chat'] = mcpython.chat.Chat.ChatInventory()
        self.inventories["enderchest"] = mcpython.gui.InventoryChest.InventoryChest()
        ...
        if mcpython.ResourceLocator.exists("build/texture/gui/icons/xp_bar_empty.png"):
            ...
            mcpython.event.EventHandler.PUBLIC_EVENT_BUS.subscribe("stage:blockitemfactory:finish", self.load_xp_icons)
