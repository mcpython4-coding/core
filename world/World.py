...
class World:
    ...
    def get_active_player(self, create: bool = True) -> typing.Union[world.player.Player, None]:
        """
    ...
    def get_active_dimension(self) -> typing.Union[world.Dimension.Dimension, None]:
        """
    ...
    def add_dimension(self, dim_id: int, name: str, dim_config=None, config=None) -> world.Dimension.Dimension:
        ...
        dim = self.dimensions[dim_id] = world.Dimension.Dimension(self, dim_id, name, genconfig=dim_config)
