...
import mcpython.world.gen.layer.Layer
import mcpython.world.gen.mode
...
class WorldGenerationTaskHandler:
    ...
    def schedule_invoke(self, chunk: mcpython.world.Chunk.Chunk, method, *args, **kwargs):
        """
    ...
    def schedule_block_add(self, chunk: mcpython.world.Chunk.Chunk, position: tuple, name: str, *args, on_add=None,
                           **kwargs):
        """
    ...
    def schedule_block_remove(self, chunk: mcpython.world.Chunk.Chunk, position: tuple, *args, on_remove=None,
                              **kwargs):
        """
    ...
    def schedule_block_show(self, chunk: mcpython.world.Chunk.Chunk, position: tuple):
        """
    ...
    def schedule_block_hide(self, chunk: mcpython.world.Chunk.Chunk, position: tuple):
        """
    ...
    def schedule_visual_update(self, chunk: mcpython.world.Chunk.Chunk, position: tuple):
        """
    ...
    def _process_0_array(self, chunk: mcpython.world.Chunk.Chunk) -> bool:
    ...
    def _process_1_array(self, chunk: mcpython.world.Chunk.Chunk) -> bool:
    ...
    def _process_2_array(self, chunk: mcpython.world.Chunk.Chunk) -> bool:
    ...
    def clear_chunk(self, chunk: mcpython.world.Chunk.Chunk):
        """
...
class WorldGenerationTaskHandlerReference:
    ...
    def __init__(self, handler: WorldGenerationTaskHandler, chunk: mcpython.world.Chunk.Chunk):
...
class WorldGenerationHandler:
    ...
    def _add_chunk(self, chunk: mcpython.world.Chunk.Chunk):
        """
    ...
    def setup_dimension(self, dimension, config=None):
        ...
        for layername in self.configs[configname]["layers"]:
            ...
            if config is None or layername not in config:
                cconfig = mcpython.world.gen.layer.Layer.LayerConfig(**(
    ...
    def __call__(self, data: str or mcpython.world.gen.layer.Layer, config=None):
        if type(data) == dict:
            self.register_world_gen_config(data, config)
        elif issubclass(data, mcpython.world.gen.layer.Layer.Layer):
...
mcpython.mod.ModMcpython.mcpython.eventbus.subscribe("stage:worldgen:mode", load_modes, info="loading generation modes")
