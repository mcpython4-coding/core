...
class ILootTableCondition(mcpython.event.Registry.IRegistryContent):
...
loottableconditionregistry = mcpython.event.Registry.Registry("loot_table_registry", ["minecraft:loot_table_condition"])
