...
class StateModLoading(State.State):
    ...
    def get_parts(self) -> list:
        return [UIPartProgressBar.UIPartProgressBar((20, 10), (20, 20), status=1, color=(1., 0., 0.)),  # stage
                UIPartProgressBar.UIPartProgressBar((20, 40), (20, 20), status=1, color=(0., 0., 1.)),  # mod
                UIPartProgressBar.UIPartProgressBar((20, 70), (20, 20), status=1, color=(0., 1., 0.)),  # item
                UIPartProgressBar.UIPartProgressBar((20, 10), (20, 20), status=1,  # memory usage
    ...
    def on_resize(self, w, h):
        for part in self.parts: part.bboxsize = (G.window.get_size()[0] - 40, 20)
