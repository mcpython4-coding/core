...
class ILootTableFunction(mcpython.event.Registry.IRegistryContent):
...
loottablefunctionregistry = mcpython.event.Registry.Registry("loottablefunctionregistry",
    ...
    def apply(self, items: list, *args, **kwargs):
        for i, itemstack in enumerate(items.copy()):
            ...
            if itemname in G.craftinghandler.furnace_recipes["minecraft:smelting"]:
                ...
                items[i] = mcpython.gui.ItemStack.ItemStack(result.output, itemstack.amount)
