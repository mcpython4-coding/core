...
class StateHandler:
    ...
    def switch_to(self, statename: str, immediate=True):
        ...
        if immediate:
            ...
            mcpython.common.event.TickHandler.handler.schedule_once(self._switch_to, statename)
    ...
    def add_state(self, state_instance: State.State):
        ...
        if state_instance.CONFIG_LOCATION is not None:
            mcpython.client.state.StateConfigFile.get_config(state_instance.CONFIG_LOCATION).inject(state_instance)
