...
from mcpython.client.chat.command.Command import SubCommand, ParseBridge, ParseType, ParseMode


@G.registry
class CommandExecute(mcpython.client.chat.command.Command.Command):
    """
