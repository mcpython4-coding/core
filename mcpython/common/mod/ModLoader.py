...
class LoadingStage:
    ...
    def call_one(self, astate):
        ...
        if self.active_mod_index >= len(G.modloader.mods):
            ...
            modinst: mcpython.common.mod.Mod.Mod = G.modloader.mods[G.modloader.modorder[self.active_mod_index]]
...
class ModLoader:
    ...
    def __init__(self):
        ...
        self.finished = False
        self.reload_stages = []
        mcpython.common.event.EventHandler.PUBLIC_EVENT_BUS.subscribe("command:reload:end", self.execute_reload_stages)
    ...
    def load_mods_toml(self, data: str, file):
        ...
        for modinstance in self.found_mod_instances:
            modinstance.add_dependency(mcpython.common.mod.Mod.ModDependency("minecraft", mc_version))
    ...
    def add_to_add(self, modinstance: mcpython.common.mod.Mod.Mod):
        """
    ...
    def process(self):
        ...
        start = time.time()
        astate: mcpython.client.state.StateModLoading.StateModLoading = G.statehandler.active_state
    ...
    def update_pgb_text(self):
        ...
        stage = LOADING_ORDER[self.active_loading_stage]
        astate: mcpython.client.state.StateModLoading.StateModLoading = G.statehandler.active_state
        modinst: mcpython.common.mod.Mod.Mod = self.mods[self.modorder[stage.active_mod_index]]
