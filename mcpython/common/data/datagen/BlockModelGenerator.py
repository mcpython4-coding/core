...
from mcpython.common.data.datagen.Configuration import IDataGenerator
...
class BlockStateGenerator(mcpython.common.data.datagen.Configuration.IDataGenerator):
    """
