...
@G.registry
class DataFixer2to3(mcpython.server.storage.datafixers.IDataFixer.IStorageVersionFixer):
...
@G.registry
class ChunkFixer2to3(mcpython.server.storage.serializer.Chunk.BlockPartFixer):
