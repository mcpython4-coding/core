...
class StateGame(State.State):
    ...
    def get_parts(self) -> list:
        return [StatePartGame.StatePartGame(), mcpython.client.gui.InventoryHandler.inventory_part]
    ...
    def on_key_press(self, symbol, modifiers):
        if symbol == key.ESCAPE and G.window.exclusive:
            ...
            mcpython.common.event.TickHandler.handler.bind(self.open_chat, 2, args=["/"])
