...
class IChunk(ABC):
    ...
    def add_block(self, position: tuple,
                  block_name: typing.Union[str, mcpython.common.block.AbstractBlock.AbstractBlock], immediate=True,
                  block_update=True, block_update_self=True,
                  lazy_setup: typing.Callable[[mcpython.common.block.AbstractBlock.AbstractBlock], None] = None):
        raise NotImplementedError()
    ...
    def remove_block(self, position: typing.Union[typing.Tuple[int, int, int], mcpython.common.block.AbstractBlock.AbstractBlock],
    ...
    def show_block(
            self,
            position: typing.Union[typing.Tuple[int, int, int], mcpython.common.block.AbstractBlock.AbstractBlock],
            immediate: bool = True,
    ):
        raise NotImplementedError()
...
class IWorld(ABC):
    ...
    def add_dimension(self, dim_id: int, name: str, dim_config=None, config=None) -> IDimension:
        raise NotImplementedError()
    ...
    def change_chunks(self, before: typing.Union[typing.Tuple[int, int], None], after: typing.Union[typing.Tuple[int, int], None], generate_chunks=True, load_immediate=True):
        raise NotImplementedError()
