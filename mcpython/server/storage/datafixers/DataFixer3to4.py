...
@G.registry
class DataFixer3to4(mcpython.server.storage.datafixers.IDataFixer.IStorageVersionFixer):
...
@G.registry
class ChunkDataFixer3to4(mcpython.server.storage.serializer.Chunk.ChunkDataFixer):
