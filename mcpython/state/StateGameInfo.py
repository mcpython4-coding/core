...
from mcpython.state.ui import UIPartImage, UIPartLable
...
class StateGameInfo(mcpython.state.State.State):
    ...
    def get_parts(self) -> list:
        parts = [mcpython.state.StatePartGame.StatePartGame(activate_physics=False, activate_mouse=False,
