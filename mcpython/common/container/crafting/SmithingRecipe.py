...
class SmithingRecipe(mcpython.common.container.crafting.IRecipe.IRecipe):
    __slots__ = mcpython.common.container.crafting.IRecipe.IRecipe.__slots__ + ("base", "addition", "output")
    ...
    def from_data(cls, data: dict, file: str) -> "SmithingRecipe":
        ...
        return cls(list(map(lambda e: e[0], transform_to_item_stack(data["base"], file))), list(map(lambda e: e[0], transform_to_item_stack(data["addition"], file))), output[0][0] if output else None)
