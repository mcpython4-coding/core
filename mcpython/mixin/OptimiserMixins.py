...
if shared.IS_CLIENT:
    ...
    def optimise():
        mixin_handler.replace_attribute_with_constant("mcpython.common.event.TickHandler:TickHandler.tick", "IS_CLIENT", True)

else:
    @shared.mod_loader("minecraft", "stage:mixin:prepare")
    def optimise():
        mixin_handler.replace_attribute_with_constant("mcpython.common.event.TickHandler:TickHandler.tick", "IS_CLIENT", False)
