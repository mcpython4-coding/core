...
import mcpython.server.gen.layer.Layer
import mcpython.server.gen.mode
...
class WorldGenerationTaskHandler:
    ...
    def get_task_count_for_chunk(self, chunk: mcpython.common.world.Chunk.Chunk) -> int:
        """
...
class WorldGenerationHandler:
    ...
    def _add_chunk(self, chunk: mcpython.common.world.Chunk.Chunk):
        """
    ...
    def register_layer(self, layer: mcpython.server.gen.layer.Layer.Layer):
    ...
    def __call__(self, data: str or mcpython.server.gen.layer.Layer, config=None):
        if type(data) == dict:
            self.register_world_gen_config(data, config)
        elif issubclass(data, mcpython.server.gen.layer.Layer.Layer):
